...
export const IncomeBreakdown: FC<Props> = ({ config, projection }) => {
  ...
  const series = [
    ...
    { key: `${partner} Take-Home`, color: '#10b981', get: (y: ProjectionResult['yearly'][number]) => y.totalSpouseSalary, show: spouse },
  ...
  return (
    <div className="p-0 sm:p-2 h-[520px] sm:h-[600px]">
      ...
      <p className="text-xs text-gray-500 mb-4">Yearly totals. The red line is all spending, including health costs and income tax.</p>
